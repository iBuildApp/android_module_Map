...
public class WebActivity extends AppBuilderModuleMainAppCompat {
    ...
    public void create() {
        ...
        setTopBarLeftButtonTextAndColor(getResources().getString(R.string.map_back), getResources().getColor(android.R.color.black),
        ...
        currentUrl = getIntent().getStringExtra(MapConstants.URL);

        widget = (Widget) getIntent().getSerializableExtra(MapConstants.EXTRA_WIDGET);
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                ...
                builder.setMessage(R.string.map_notification_error_ssl_cert_invalid);
                builder.setPositiveButton(WebActivity.this.getResources().getString(R.string.map_on_continue), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        handler.proceed();
                    }
                });
                builder.setNegativeButton(WebActivity.this.getResources().getString(R.string.map_on_cancel), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        handler.cancel();
                    }
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains("youtube.com")) {
                    ...
                    WebActivity.this.startActivity(Intent.createChooser(emailIntent, getString(R.string.map_send_email)));
    ...
    private void showProgress() {
        progressDialog = ProgressDialog.show(this, null, getString(R.string.map_loading), true);
